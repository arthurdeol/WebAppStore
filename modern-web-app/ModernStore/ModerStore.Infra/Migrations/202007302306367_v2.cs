namespace ModerStore.Infra.Migrations
{
    ...
    public partial class v2 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Username = c.String(nullable: false, maxLength: 32, fixedLength: true),
        ...
        public override void Down()
        {
            ...
            AddColumn("dbo.Customer", "User_Password", c => c.String(nullable: false, maxLength: 20));
            AddColumn("dbo.Customer", "User_Username", c => c.String(nullable: false, maxLength: 32, fixedLength: true));
